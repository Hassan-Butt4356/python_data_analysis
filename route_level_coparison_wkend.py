...
cr_df=pd.read_excel('project_CR_Santa Clarita (3).xlsx',sheet_name='WkEND-Overall')
# this is for overall goal values
wkday_route_df=pd.read_excel('project_CR_Santa Clarita (3).xlsx',sheet_name='WkEND-RouteTotal')
...
with pd.ExcelWriter('SantaClarita Route Level Comparison(WkEnd).xlsx') as writer:
