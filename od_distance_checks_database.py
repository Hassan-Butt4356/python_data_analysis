...
# for _,row in df[['O_B_Dist_Check1','O_B_Dist_Check2','O_B_Dist_Check3','A_D_Dist_Check1','A_D_Dist_Check2','A_D_Dist_Check3','O_D_Dist_Check1','O_D_Dist_Check2','O_D_Dist_Check3','B_A_Dist_Check1','B_A_Dist_Check2']].iterrows():
#     if row['O_B_Dist_Check1'] == 1:
#         df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Origin To Board distance greater than 1.85 miles and Access Mode is Walk'
#     elif row['O_B_Dist_Check2'] == 1:
#         df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Origin To Board distance less than 0.25 miles and Access Mode is Not Walk'
#     elif row['O_B_Dist_Check3'] == 1:
#         df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Origin To Board distance less than 0.25 miles and Prev Transfers are present'
#     elif row['A_D_Dist_Check1'] == 1:
#         df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Last Alighting To Destination distance greater than 1.85 miles and Egress Mode is Walk'
#     elif row['A_D_Dist_Check2'] == 1:
#         df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Last Alighting To Destination distance less than 0.25 miles and Egress Mode is Not Walk'        
#     elif row['A_D_Dist_Check3'] == 1:
#         df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Survey Alighting To Destination distance less than 0.25 miles and Next Transfers are present'
#     elif row['O_D_Dist_Check1'] == 1:
#             df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Origin To Destination distance less than 0.05 miles'
#     elif row['O_D_Dist_Check2'] == 1:
#             df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Origin To Destination distance less than 0.25 miles'
#     elif row['O_D_Dist_Check3'] == 1:
#             df.loc[row.name,'O_D_Distance_Flag_Description'] = 'Origin To Destination distance greater than 50 miles'
#     elif row['B_A_Dist_Check1'] == 1:
#             df.loc[row.name,'O_D_Distance_Flag_Description'] = 'B2A/OD(Boarding to Alighting divied by Origin to Destination) greater than 1.75 miles'
#     elif row['B_A_Dist_Check1'] == 1:
#             df.loc[row.name,'O_D_Distance_Flag_Description'] = 'B2A/OD(Boarding to Alighting divied by Origin to Destination) less than 0.45 miles. Access and Egress Mode is Walk. Next and Prev transfers are 0'
#     else:
#         df.loc[row.name,'O_D_Distance_Flag_Description'] = ' '
...
# powerbi_columns
new_df_columns=['ORIGIN_TO_SURVEYBOARD','ORIGIN_TO_FIRST_BOARD','SURVEYBOARDING_TO_SURVEYALIGHTING','ORIGIN_TO_DESTINATION','SURVEYALIGHTING_TO_DESTINATION','LAST_ALIGHTING_LOCATION_TO_DESTIN','O2B/O2D','B2A/OD','A2D/OD','O_B_Dist_Check1','O_B_Dist_Check2','O_B_Dist_Check3','A_D_Dist_Check1','A_D_Dist_Check2','A_D_Dist_Check3','O_D_Dist_Check1','O_D_Dist_Check2','O_D_Dist_Check3','B_A_Dist_Check1','B_A_Dist_Check2','SUM_ALL_CHECKS']
...
od_df[od_df['SUM_ALL_CHECKS']==1].to_csv(f'reviewtool_{today_date}_{project_name}_OD_Distance_Checks_Database.csv',index=False)
