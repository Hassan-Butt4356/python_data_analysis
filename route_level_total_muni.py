...
wkend_comparison_df.rename(columns={'CR_Early_AM':'(0) Goal','CR_AM_Peak':'(1) Goal','CR_Midday':'(2) Goal','CR_PM':'(3) Goal','CR_PM_Peak':'(4) Goal','CR_Evening':'(5) Goal','CR_Night':'(6) Goal','DB_Early_AM_Peak':'(0) Collect',
         'DB_AM_Peak':'(1) Collect',
       'DB_Midday':'(2) Collect', 'DB_PM':'(3) Collect', 'DB_PM_Peak':'(4) Collect', 'DB_Evening':'(5) Collect','DB_Night':'(6) Collect',  'Early_AM_DIFFERENCE':'(0) Remain', 'AM_DIFFERENCE':'(1) Remain', 'Midday_DIFFERENCE':'(2) Remain',
       'PM_DIFFERENCE':'(3) Remain', 'PM_PEAK_DIFFERENCE':'(4) Remain' ,'Evening_DIFFERENCE':'(5) Remain','Night_DIFFERENCE':'(6) Remain','CR_Overall_Goal':'Route Level Goal','DB_Total':'# of Surveys','Overall_Goal_DIFFERENCE':'Remaining'},inplace=True)

wkday_comparison_df.rename(columns={'CR_Early_AM':'(0) Goal','CR_AM_Peak':'(1) Goal','CR_Midday':'(2) Goal','CR_PM':'(3) Goal','CR_PM_Peak':'(4) Goal','CR_Evening':'(5) Goal','CR_Night':'(6) Goal','DB_Early_AM_Peak':'(0) Collect',
         'DB_AM_Peak':'(1) Collect',
       'DB_Midday':'(2) Collect', 'DB_PM':'(3) Collect', 'DB_PM_Peak':'(4) Collect', 'DB_Evening':'(5) Collect','DB_Night':'(6) Collect',  'Early_AM_DIFFERENCE':'(0) Remain', 'AM_DIFFERENCE':'(1) Remain', 'Midday_DIFFERENCE':'(2) Remain',
       'PM_DIFFERENCE':'(3) Remain', 'PM_PEAK_DIFFERENCE':'(4) Remain' ,'Evening_DIFFERENCE':'(5) Remain','Night_DIFFERENCE':'(6) Remain','CR_Overall_Goal':'Route Level Goal','DB_Total':'# of Surveys','Overall_Goal_DIFFERENCE':'Remaining'},inplace=True)

wkday_route_direction_df.rename(columns={'CR_Early_AM':'(0) Goal','CR_AM_Peak':'(1) Goal','CR_Midday':'(2) Goal','CR_PM':'(3) Goal','CR_PM_Peak':'(4) Goal','CR_Evening':'(5) Goal','CR_Night':'(6) Goal','DB_Early_AM_Peak':'(0) Collect',
         'DB_AM_Peak':'(1) Collect',
       'DB_Midday':'(2) Collect', 'DB_PM':'(3) Collect', 'DB_PM_Peak':'(4) Collect', 'DB_Evening':'(5) Collect','DB_Night':'(6) Collect',  'Early_AM_DIFFERENCE':'(0) Remain', 'AM_DIFFERENCE':'(1) Remain', 'Midday_DIFFERENCE':'(2) Remain',
       'PM_DIFFERENCE':'(3) Remain', 'PM_PEAK_DIFFERENCE':'(4) Remain' ,'Evening_DIFFERENCE':'(5) Remain','Night_DIFFERENCE':'(6) Remain','CR_Overall_Goal':'Route Level Goal','DB_Total':'# of Surveys','Overall_Goal_DIFFERENCE':'Remaining'},inplace=True)

wkend_route_direction_df.rename(columns={'CR_Early_AM':'(0) Goal','CR_AM_Peak':'(1) Goal','CR_Midday':'(2) Goal','CR_PM':'(3) Goal','CR_PM_Peak':'(4) Goal','CR_Evening':'(5) Goal','CR_Night':'(6) Goal','DB_Early_AM_Peak':'(0) Collect',
         'DB_AM_Peak':'(1) Collect',
       'DB_Midday':'(2) Collect', 'DB_PM':'(3) Collect', 'DB_PM_Peak':'(4) Collect', 'DB_Evening':'(5) Collect','DB_Night':'(6) Collect',  'Early_AM_DIFFERENCE':'(0) Remain', 'AM_DIFFERENCE':'(1) Remain', 'Midday_DIFFERENCE':'(2) Remain',
       'PM_DIFFERENCE':'(3) Remain', 'PM_PEAK_DIFFERENCE':'(4) Remain' ,'Evening_DIFFERENCE':'(5) Remain','Night_DIFFERENCE':'(6) Remain','CR_Overall_Goal':'Route Level Goal','DB_Total':'# of Surveys','Overall_Goal_DIFFERENCE':'Remaining'},inplace=True)
