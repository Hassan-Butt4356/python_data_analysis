...
have5mint_column_check=['have5minforsurvecode']
have5mint_column=check_all_characters_present(df,have5mint_column_check)

df=df[df['INTERV_INIT']!='999']
# ke_df=ke_df[ke_df['INTERV_INIT']!='999']
# ke_df=ke_df[ke_df['INTERV_INIT']!=999]
# ke_df=ke_df[ke_df['HAVE_5_MIN_FOR_SURVECode']==1]
df=df[df[have5mint_column[0]]==1]
df=df[df['INTERV_INIT']!='999']
df=df[df['INTERV_INIT']!=999]
...
df['ROUTE_SURVEYEDCode_SPLITED']=df[route_surveyed_column[0]].apply(lambda x : '_'.join(str(x).split('_')[0:-1]))
...
#     ]
    filtered_df = detail_df[detail_df['ETC_ROUTE_ID'] == row[route_surveyed_column[0]]][
        ['stop_lat6', 'stop_lon6', 'seq_fixed', 'ETC_STOP_ID','ETC_STOP_NAME']
    ]
...
#         ['stop_lat6', 'stop_lon6', 'seq_fixed', 'ETC_STOP_ID','ETC_STOP_NAME']
#     ]
    filtered_df = detail_df[(detail_df['ETC_ROUTE_ID'] == row[route_surveyed_column[0]])&(detail_df['ETC_STOP_DIRECTION']==stop_on_direction)][
        ['stop_lat6', 'stop_lon6', 'seq_fixed', 'ETC_STOP_ID','ETC_STOP_NAME']
    ]
